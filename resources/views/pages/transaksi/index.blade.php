                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($t->bukti_bayar)
                                            <a href="#" data-bs-toggle="modal" data-original-title="Lihat Bukti Booking"
                                                ...
                                                <img src="{{ Storage::disk('public')->url('upload/bukti/' . $t->bukti_bayar) }}"
                                    ...
                                    <td>
                                        <ul class="action gap-2">
                                            <li class="edit"><a href="{{ route('transakci.invoice', $t->id) }}"
                                                    title="Print Invoice"><i class="fa fa-print"></i></a></li>
                                        </ul>
                                    </td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="viewBuktiModal-{{ $t->id }}Label">
                                                        Bukti Pembayaran Booking, {{ $t->customer_id }}</h5>
